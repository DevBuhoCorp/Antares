  ...
  FPerfilChange(e) {
    ...
    if (files.length > 0) {
      reader.onloadend = () => {
        ...
        try {
          this.DatosPersonales[0].FotoPerfil = this.DatosPersonales[0].FotoPerfil.replace(
          ...
          .subscribe(
            data => {
              ...
              this.FotoPerfil =
                ...
                this.DatosPersonales[0].FotoPerfil.replace(/,/g, "");
              this.DatosPersonales[0].FotoPerfil = this._sanitizer.bypassSecurityTrustResourceUrl(
                "data:image/jpeg;base64," +
                  this.DatosPersonales[0].FotoPerfil.replace(/,/g, "")
              );
            },
